...
var fs__namespace = /*#__PURE__*/_interopNamespace(fs$3);
...
var $indexOf = callBind$4(GetIntrinsic$6('String.prototype.indexOf'));
...
var $strSlice = callBound$3('String.prototype.slice');
...
var ToNumber$4 = function ToNumber(argument) {
	var value = isPrimitive$1(argument) ? argument : ToPrimitive$2(argument, $Number);
	if (typeof value === 'symbol') {
...
var $abs$1 = GetIntrinsic$3('%Math.abs%');
...
var callBind$2 = callBind$5;

var ArrayPush = callBound$1('Array.prototype.push');
var StringFromCharCodeSpread = callBind$2.apply(String.fromCharCode, null);

var implementation$5 = function fromCodePoint(_ /* fromCodePoint.length is 1 */) {
	var MAX_SIZE = 0x4000;
	var codeUnits = [];
	var highSurrogate;
	var lowSurrogate;
	...
	var result = '';
	while (++index < length) {
		var codePoint = ToNumber$3(arguments[index]);
		if (
			!IsInteger(codePoint) ||
...
var polyfill$1 = function getPolyfill() {
	return String.fromCodePoint || implementation$4;
};
...
var shim$3 = function shimFromCodePoint() {
	var polyfill = getPolyfill$3();

	if (String.fromCodePoint !== polyfill) {
		define$3(String, { fromCodePoint: polyfill });
	}
...
var boundFromCodePoint = callBind$1(getPolyfill$2(), String);

define$2(boundFromCodePoint, {
...
var ToNumber$2 = function ToNumber(value) {
...
var getGlyphsData = function (files, options) {
    ...
    return Promise.all(files.map(function (srcPath) { return throttle(function () { return new Promise(function (resolve, reject) {
        var glyph = fs__default['default'].createReadStream(srcPath);
        var glyphContents = "";
...
var webfont = function (initialOptions) { return __awaiter(void 0, void 0, void 0, function () {
    var options, config, foundFiles, filteredFiles, glyphsData, ttfOptions, svg, ttf, result, _a, builtInTemplates, templateFilePath, builtInPath, resolvedTemplateFilePath, hashOption, nunjucksOptions;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                options = __assign({ centerHorizontally: false, descent: 0, fixedWidth: false, fontHeight: null, fontId: null, fontName: "webfont", fontStyle: "", fontWeight: "", formats: ["svg", "ttf", "eot", "woff", "woff2"], formatsOptions: {
                        ttf: {
                            copyright: null,
                            ts: null,
                            version: null
            ...
            case 4:
                ...
                if (!options.formats.includes("woff2")) return [3 /*break*/, 6];
                _a = result;
            ...
            case 6:
                if (options.template) {
                    ...
                    nunjucksOptions = deepmerge__default['default'].all([
                        {
                            glyphs: result.glyphsData.map(function (glyphData) {
...
if (typeof meowCLI.flags.config === "string") {
    ...
    optionsBase.configFile =
        require$$1__default['default'](process.cwd(), meowCLI.flags.config) ||
